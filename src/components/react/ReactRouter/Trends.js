...
class Trends extends Component{
    render(){
        const id='/content/${value.aid}'
        const location='/productcontent?name=${value.aid}'
        return(
            <div>
                <div >
                    <h3 className='Title_h3'>动态路由</h3>
                    <div>官网：<a href='https://reacttraining.com/react-router/web/example/basic' target='_blank' rel="nofollow me noopener noreferrer">
                    ...
                    <h3 >js跳转路由</h3>
                    <div>官网：<a href='https://reacttraining.com/react-router/web/example/auth-workflow' target="_blank" rel="nofollow me noopener noreferrer">
