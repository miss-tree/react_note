            ...
            <div>
                <div >
                    ...
                    <div className="hang">
                        ...
                        <div>this.props.match.params  <span>对应的动态路由加载的组件里面获取传值</span></div>
                        <div><code>{`<Link to={${location}}>{value.title}</Link>`}</code><span>跳转页面get方式带参数name</span></div>
                        <div>this.props.location.search  <span>获取 react get传值</span></div>
                    </div>
                    <h3 >js跳转路由</h3>
                    <div>官网：https://reacttraining.com/react-router/web/example/auth-workflow</div>
                    <div className="hang">
